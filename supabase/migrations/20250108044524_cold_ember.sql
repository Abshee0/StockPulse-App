/*
  ...
  1. Changes
    ...
    - Add basic read access policies
*/
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    WHERE tablename = 'categories' AND policyname = 'Categories are manageable by admins and managers'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'profiles' AND policyname = 'Profiles are manageable by admins and managers'
  ) THEN
